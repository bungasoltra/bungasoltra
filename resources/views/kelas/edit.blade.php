                                ...
                                <div class="p-1">
                                    <form action="{{route('kelas.update',$kelas->id)}}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="row my-2">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="nama_kelas" id="nama_kelas" class="form-control form-control-sm" value="{{$kelas->nama_kelas}}">
                                        ...
                                        <div class="row my-2">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="kompetensi_keahlian" id="kompetensi_keahlian" class="form-control form-control-sm" value="{{$kelas->kompetensi_keahlian}}">
